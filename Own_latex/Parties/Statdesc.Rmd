...
Le prix des biens, le nombre de pièces, le nombre de pièces et la surface vont être analyser plus en détails.
...
### Statistique descriptive de la variables  expliquer
...
prix_biens <- ggplot(biens_stat_des, aes(x = prix)) +
        ...
        scale_x_continuous(breaks=seq(0,4500000,250000))+theme(axis.text.x = element_text(angle=90, size=rel(0.8),vjust = 0.15)) + ggtitle("Répartition du prix de l'ensemble des biens")
prix_biens
...
rep_biens <- rep_biens +ggtitle("Répartition du prix d'un bien en fonction du type de bien")+ geom_boxplot()+ scale_y_continuous(name="prix des biens")+ theme(axis.text.x = element_blank())
rep_biens
